...
router.put('/seller-profile', authenticate, authorize('seller'), async (req: AuthRequest, res) => {
  try {
    ...
    const updateData: any = {
      ...
      description,
      address,
      latitude: latitude !== undefined ? (latitude !== null ? Number(latitude) : null) : existingProfile?.latitude,
      longitude: longitude !== undefined ? (longitude !== null ? Number(longitude) : null) : existingProfile?.longitude,
      phone,
      whatsappNumber,
      email,
      logo,
  ...
  try {
    ...
    const updatedProfile = await prisma.sellerProfile.upsert({
      ...
      update: {
        ...
        description,
        address,
        latitude: latitude !== undefined ? (latitude !== null ? Number(latitude) : null) : user.sellerProfile?.latitude,
        longitude: longitude !== undefined ? (longitude !== null ? Number(longitude) : null) : user.sellerProfile?.longitude,
        phone,
        whatsappNumber,
        email,
        logo,
