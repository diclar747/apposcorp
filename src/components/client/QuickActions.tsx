...
export function QuickActions({ className, onAction }: QuickActionsProps) {
  const actions: QuickAction[] = [
    ...
    { icon: ScanLine, label: 'Recargar', href: '/app/wallet/recargar', bgColor: 'bg-orange-50', iconColor: 'text-orange-500' },
    { icon: ShoppingBag, label: 'E-Commerce', href: '/app/tiendas', bgColor: 'bg-purple-50', iconColor: 'text-purple-500' },
    { icon: GraduationCap, label: 'Cursos', onClick: () => onAction?.('Cursos'), bgColor: 'bg-amber-50', iconColor: 'text-amber-500' },
    { icon: QrCode, label: 'Historial', href: '/app/wallet', bgColor: 'bg-blue-50', iconColor: 'text-blue-600' },
    { icon: ScanLine, label: 'Ajustes', href: '/app/perfil', bgColor: 'bg-slate-50', iconColor: 'text-slate-500' },
  ];
