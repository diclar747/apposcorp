  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6 pb-6">
      <div>
        ...
        <p className="text-gray-500">Administrador del sistema</p>
      </div>
        ...
        <CardContent className="p-6">
          {isEditing ? (
            ...
            <div className="flex flex-col items-center">
              ...
              <span className="text-xs bg-purple-100 text-purple-700 px-2 py-0.5 rounded-full mt-1 font-medium">Super Admin</span>
